...
www: clean
	...
	#compile javascript
	mkdir -p ${OUT}/js
	cd source; uglifyjs dashboard.js debug.js charts.js ohmage.js choropleth.js photopanel.js piechart.js barchart.js datechart.js hourchart.js wordcloud.js responsemodal.js filtercount.js help.js -o ${OUT}/js/snack.min.js
